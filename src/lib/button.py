...
class Button:
  def __init__(self, pin, leds, index, __function_state):
  ...
  def __press(self, state):
    ...
    try:  
      ...
      print("Button: ", self.pin, ", LED: ", self.LEDS.LEDS[self.index], " Pressed") if state else print("Button: ", self.pin, ", LED: ", self.LEDS.LEDS[self.index], " Released")
      print('')
      ##
    except IndexError:
